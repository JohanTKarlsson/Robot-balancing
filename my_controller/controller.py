...
while robot.step(64) != -1:
    ...
    gyro_adjustment = gyro_values[1] * 0.05  # Adjust leg position based on gyro Y-axis value
    accel_adjustment = accel_values[1] * 0.0025  # Adjust leg position based on accelerometer Y-axis value
